@include('moderator.dashboard.sidebar')
<div id="main">
    <header class="mb-3">
            ...
            <div class="card mb-3">
                ...
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item active">Atik Habib</li>
                            <li class="list-group-item">Abtahi Tajwar</li>
                            <li class="list-group-item">Shariar Sijan Alvi</li>
        ...
        <div class="col-12 col-lg-8">
            <div class="container">
                <div class="avatar avatar-xl">
                        <img src="{{ asset('img/moderator/5.jpg') }}" alt="">                       
                </div>
                                ...
                                <tbody>
                                        ...
                                        <td class="col-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-md">
                                                    <img src="{{ asset('img/moderator/5.jpg') }}" alt="Face 1">
                                                </div>
                                    ...
                                    <tr>
                                        <td class="col-3">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-md">
                                                    <img src="{{ asset('img/moderator/4.jpg') }}" alt="Face 1">
                                                </div>
...
@include('moderator.dashboard.footer')