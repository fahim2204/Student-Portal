                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-12 d-flex align-items-center ms-2 mb-1">
                            ...
                            <a href="#user-profile"
                                ...
                                href="#user-profile">
                            <div class="lh-sm text-danger align-self-end me-4">{{ $post->created_at->diffForHumans() }}
                            </div>
                            @if (session()->get('id')===$post->fr_user_id)
                            <div class="d-flex ms-4">
                                <div><a
                                        class="btn btn-outline-info p-2 py-0 text-decoration-none text-primary" href="{{ route('posts.edit', [$post->category->name, $post->id]) }}">edit</a>
                                </div>
                                <div class="">|</div>
                                <div class="">
                                    <form action="{{ route('posts.delete', $post->id) }}" method="post">
                                        {{-- <input type="hidden"> --}}
                                        <input class="btn btn-outline-danger p-2 py-0" type="submit" value="Delete" onclick="return deletePostConfirmation()">
                                    </form>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="col-6 d-flex align-items-center border-top p-1 ">
                        ...
                        <div class="col-6 justify-content-end d-flex align-items-center border-top p-1 ">
