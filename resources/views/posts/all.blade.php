...
{{-- <main class="container">
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <div class="container posts mb-3 col-12"> 
              ...
              <div class="row g-0">
                  ...
                  <div class="col-12 col-lg-8 d-flex align-items-center ms-2 mb-1">
                      <div class="text-primary">
                        <a href="{{route('posts.view.cat',$post->category->name)}}" class="text-decoration-none">{{$post->category->name}}</a>
                      </div>
                      <div class="mx-1">|</div>
                      <div class="lh-sm text-muted align-self-center me-1" style="font-size: 12px">Posted By</div>
                      <a href="{{route('profile.view',$post->user->uname)}}" class="fs-6 text-success me-1 text-decoration-none">{{$post->user->uname}}</a>
                      <div class="lh-sm text-danger align-self-end" style="font-size: 12px">{{$post->updated_at->diffForHumans()}}</div>
                  </div>
                  <!-- Post header section  -->
                  ...
                  <div class="col-8 d-flex align-items-center border-top p-1 ">
                      <div class="border border-0 bg-info px-2" style="border-radius: 30px;"><a href=""><i class="fas fa-arrow-alt-circle-up me-1"></i>{{count($post->votes)}} <i class="text-muted"></a>|<a href=""></i><i class="fas fa-arrow-alt-circle-down ms-1"></i></a></div>
